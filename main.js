  ...
  form.addEventListener("submit", function (e) {
    ...
    if (name === "") {
      ...
      Swal.fire({
        icon: "success",
        title: "Welcome " + name + "!",
        text: "You are now part of our Ice Cream Family 🍦❤️ For tasting more flavours, do visit our shop😊 Have a good day!❤️",
        confirmButtonColor: "#d41111",
      });
...
document.querySelectorAll(".buy-btn").forEach((button) => {
  button.addEventListener("click", () => {
    Swal.fire({
      icon: "info",
      title: "Coming Soon!",
      text: "Online ordering will be available soon 🍦",
      confirmButtonColor: "#d41111",
    });
  });
});
